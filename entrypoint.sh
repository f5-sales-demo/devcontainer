...
# Written EARLY (before service startup) so the env file exists
# even if a service hangs. Shells created by "podman exec" inherit
# the container's base environment, which lacks vars exported above.
