...
- **Auto memory** (`~/.claude/projects/*/memory/MEMORY.md`) — a tool name reference table loaded into every conversation context
- **Project rules** (`.claude/rules/`) — instructions loaded alongside `CLAUDE.md` every session
