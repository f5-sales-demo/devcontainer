...
| Variable | Description | Example |
|----------|-------------|---------|
| `GH_TOKEN` | GitHub personal access token for `gh` CLI and HTTPS git | `ghp_abc123...` |
...
Both [fine-grained tokens](https://github.com/settings/tokens?type=beta) (recommended) and classic tokens work. Fine-grained tokens let you scope access to specific repositories. Classic tokens require the `repo` scope for private repository access.
