...
[github.com/settings/tokens](https://github.com/settings/tokens) पर टोकन बनाएँ। फाइन-ग्रेंड टोकन (अनुशंसित) या `repo` स्कोप वाले क्लासिक टोकन दोनों काम करते हैं। `.env` अपडेट करने के बाद कंटेनर को पुनः शुरू करें।
