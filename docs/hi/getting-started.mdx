...
यदि आप Apple Silicon वाले macOS पर हैं, तो इस पेज को छोड़ें और [एक-पंक्ति इंस्टॉलर](/devcontainer/install/) का उपयोग करें:
...
**Linux** पर, कंटेनर सीधे होस्ट संसाधनों को साझा करते हैं — कोई संसाधन कॉन्फ़िगरेशन आवश्यक नहीं है।
...
:::tip[AI सहायक]
`.env.example` फ़ाइल में हर उस वेरिएबल पर `@auto-detect` मार्कर हैं जो स्थानीय टूल से भरे जा सकते हैं। Claude Code जैसे AI सहायक इन मार्करों को स्कैन कर सकते हैं और स्वचालित रूप से एक पूर्ण `.env` बनाने के लिए संबंधित कमांड चला सकते हैं।
:::
...
Claude Code बिल्ट-इन Chrome DevTools MCP सर्वर का उपयोग करके वेब पेज नेविगेट कर सकता है, स्क्रीनशॉट ले सकता है, और DOM का निरीक्षण कर सकता है। कोई सेटअप आवश्यक नहीं — यह हेडलेस मोड में स्वचालित रूप से काम करता है। विवरण के लिए [Chrome DevTools MCP](./chrome) देखें।
...
आपका `/workspace` और होम डायरेक्टरी में कोड पुनः शुरू करने पर भी बना रहता है। विवरण के लिए [कॉन्फ़िगरेशन — डेटा स्थायित्व](./configuration#data-persistence) देखें।

---

स्थानीय बिल्ड और Dockerfile अनुकूलन के लिए, [स्थानीय विकास](./local-development) देखें। VS Code एकीकरण के लिए, [VS Code](./vscode) देखें। रिमोट डिस्प्ले विकल्पों के लिए, [रिमोट डिस्प्ले (noVNC)](./vnc) देखें।
