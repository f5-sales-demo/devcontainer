---
title: VS Code
description: ใช้ Dev Container ร่วมกับเวิร์กโฟลว์ "Reopen in Container" ของ VS Code
sidebar:
  order: 6
i18n:
...
3. Docker หรือ Podman ที่ทำงานอยู่บนเครื่องของคุณ (ดู [เริ่มต้นใช้งาน](./getting-started#container-runtime)) VS Code Dev Containers ยังรองรับ [Podman เป็นแบ็กเอนด์](https://code.visualstudio.com/remote/advancedcontainers/docker-options#_podman) ด้วย
