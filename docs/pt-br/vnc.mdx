...
description: >-
  Assista e interaja com navegadores em modo visível através de uma tela virtual
  no seu navegador.
sidebar:
  order: 3
i18n:
...
Consulte [Solução de Problemas — Exibição Remota](./troubleshooting#remote-display-novnc) para soluções de tela preta, erros de conexão recusada e conflitos de porta.
