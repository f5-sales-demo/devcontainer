...
description: Um único comando para instalar e configurar o devcontainer no macOS.
sidebar:
  order: 0
i18n:
...
2. Configura o iTerm2 (fonte, sino, histórico de rolagem, tema escuro, atalho Shift+Enter)
3. Inicializa e ajusta a máquina Podman (16 GB de RAM, 4 CPUs, 220 GB de disco, zram, swappiness)
4. Baixa `docker-compose.yml`, `devcontainer.sh` e o template `.env` no diretório atual
...
| `.env` | Suas credenciais (a partir do template, edite antes da primeira execução) |
