...
Si Homebrew n'est pas installé, le script s'arrête en affichant les instructions.
Votre service informatique peut fournir Homebrew en tant que logiciel géré — vérifiez auprès d'eux au préalable.
:::
