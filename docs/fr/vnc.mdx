...
Les agents IA utilisant `@playwright/mcp` en mode graphique rendent Chromium dans cet affichage. Vous pouvez cliquer et saisir du texte directement dans la fenêtre noVNC pour intervenir à tout moment — aucune pause/reprise n'est nécessaire.
...
Consultez [Dépannage — Affichage distant](./troubleshooting#remote-display-novnc) pour les solutions aux écrans noirs, erreurs de connexion refusée et conflits de ports.
