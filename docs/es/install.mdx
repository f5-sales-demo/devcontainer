...
Si Homebrew no está instalado, el script finalizará con instrucciones.
Es posible que su departamento de TI proporcione Homebrew como software administrado — consúltelo primero con ellos.
:::
