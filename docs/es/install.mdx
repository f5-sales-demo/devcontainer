...
Este único comando gestiona toda la configuración inicial:
...
Su departamento de TI puede proporcionar Homebrew como software administrado — consulte con ellos primero.
:::
...
El script detecta su zona horaria y obtiene un token de GitHub actualizado desde `gh auth token` en cada ejecución.
...
| `.env` | Sus credenciales (desde la plantilla, edite antes del primer inicio) |
