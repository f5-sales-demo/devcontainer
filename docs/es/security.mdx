...
Todos los datos residen en volúmenes nombrados de Docker — no en directorios del anfitrión montados por enlace. Un compromiso dentro del contenedor **no puede** acceder a archivos en su máquina anfitriona. Consulte [Configuración — Persistencia de Datos](./configuration#data-persistence) para detalles sobre los volúmenes.
