...
Jede Laufzeitumgebung, CLI und jedes Tool wird direkt im `Dockerfile` zur Build-Zeit installiert. Das vorgefertigte Image wird bei jedem Push auf `main` auf `ghcr.io/f5xc-salesdemos/devcontainer:latest` veröffentlicht, sodass die meisten Benutzer nie lokal bauen müssen.
