...
2. Konfiguriert iTerm2 (Schriftart, Signalton, Scrollback, dunkles Theme, Shift+Enter-Tastenkombination)
...
Falls Homebrew nicht installiert ist, wird das Skript mit entsprechenden Anweisungen beendet.
...
Nach Ausführung des Installers enthält Ihr Verzeichnis:
