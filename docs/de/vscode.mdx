...
3. Docker oder Podman auf Ihrem Rechner (siehe [Erste Schritte](./getting-started#container-runtime)). VS Code Dev Containers unterstützt auch [Podman als Backend](https://code.visualstudio.com/remote/advancedcontainers/docker-options#_podman).
...
VS Code leitet automatisch die in der Compose-Datei definierten Ports weiter. Die noVNC-Anzeige ist unter `http://localhost:6080/vnc.html` verfügbar — VS Code benachrichtigt Sie, wenn der Port bereit ist.
...
Wenn Sie die Befehlszeile der VS Code-Benutzeroberfläche vorziehen:
