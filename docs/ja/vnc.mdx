...
description: 仮想ディスプレイを通じて、ブラウザからヘッド付きブラウザの表示を確認し操作できます。
sidebar:
  order: 3
i18n:
...
黒い画面、接続拒否エラー、ポート競合の解決策については、[トラブルシューティング — リモートディスプレイ](./troubleshooting#remote-display-novnc)を参照してください。
