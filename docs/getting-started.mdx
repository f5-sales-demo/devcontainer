...
The first build takes 5-10 minutes (all languages, CLIs, and tools are compiled/downloaded). Subsequent builds use Docker layer caching and are much faster.
