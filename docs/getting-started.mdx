...
```ini
ANTHROPIC_BASE_URL=https://your-litellm-endpoint.example.com/anthropic
ANTHROPIC_API_KEY=your-api-key
```

Claude Code connects directly to the endpoint without any built-in translation layer.
...
Claude Code can navigate web pages, take screenshots, and inspect the DOM using the built-in Chrome DevTools MCP server. No setup needed — it works automatically in headless mode. See [Chrome DevTools MCP](./chrome) for details.
