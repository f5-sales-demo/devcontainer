...
Questa pagina è destinata agli sviluppatori che desiderano clonare il repository, compilare l'immagine localmente o personalizzare il Dockerfile. Se si desidera semplicemente utilizzare il container pre-compilato, consultare [Per Iniziare](./getting-started).
