---
title: Test di registrazione dello schermo
description: >-
...
4. Naviga su `https://example.com` (pausa di 3 s), poi su `https://httpbin.org` (pausa di 3 s)
5. Invia SIGTERM a ffmpeg per la finalizzazione pulita del file MP4
...
Il file MP4 dovrebbe mostrare la finestra di Chromium che renderizza entrambi i siti web sul desktop fluxbox. Riproducetelo con `ffplay`, `vlc`, oppure scaricatelo dal container per verificare.
