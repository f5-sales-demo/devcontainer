...
2. Configura iTerm2 (font, campanella, scrollback, tema scuro, combinazione tasti Shift+Invio)
...
| `.env` | Le vostre credenziali (dal template, modificatelo prima del primo avvio) |
