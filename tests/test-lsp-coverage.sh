...
test_plugin_enabled "terraform-lsp@f5-sales-demo-marketplace"
test_plugin_enabled "json-lsp@f5-sales-demo-marketplace"
test_plugin_enabled "bash-lsp@f5-sales-demo-marketplace"
test_plugin_enabled "yaml-lsp@f5-sales-demo-marketplace"
test_plugin_enabled "css-lsp@f5-sales-demo-marketplace"
test_plugin_enabled "html-lsp@f5-sales-demo-marketplace"
test_plugin_enabled "eslint-lsp@f5-sales-demo-marketplace"
test_plugin_enabled "markdown-lsp@f5-sales-demo-marketplace"
test_plugin_enabled "mdx-lsp@f5-sales-demo-marketplace"

echo "--- Native TypeScript plugin ---"
test_plugin_enabled "tsgo-lsp@f5-sales-demo-marketplace"

echo "--- New plugins (6 plugins) ---"
test_plugin_enabled "toml-lsp@f5-sales-demo-marketplace"
